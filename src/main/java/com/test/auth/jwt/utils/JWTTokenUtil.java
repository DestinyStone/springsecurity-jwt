package com.test.auth.jwt.utils;
...
public class JWTTokenUtil {
    ...
    @Autowired
    public void setProperties(JWTTokenProperties properties) {
        JWTTokenUtil.properties = properties;
    }
    ...
    public static  Date generateExpirationDate() {
        return new Date(System.currentTimeMillis() + properties.getExpried());
    }
    ...
    public static  String refreshHeadToken(String oldToken) {
        ...
        String token = oldToken.substring(properties.getHead().length());
